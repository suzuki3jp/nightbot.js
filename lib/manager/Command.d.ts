...
import { CustomCommandData, CustomCommandResponse, UserLevel, DefaultCommandResponse, GetDefaultCommandsResponse } from '../api-types/index';
/**
...
export declare class CommandManager extends Base {
     ...
     */
    editDefaultCommand(name: string, options: EditDefaultCommandOptions): Promise<DefaultCommandResponse | null>;
}
